...
public class When_dividing_2_by_2_quarters_without_normalization : Spec {
    ...
    [Test]
    public void The_result_should_be_4_over_1() {
        Assert.That(_result, Is.EqualTo(new Fraction(4, 1, false)).Using(StrictTestComparer.Instance));
    }
}
...
public class When_dividing_without_normalization {
    private static IEnumerable<TestCaseData> PositiveResultCases {
        get {
            ...
            yield return new TestCaseData(
                ...
                new Fraction(10, 100, false),
                new Fraction(1, 1, false));
            // {10/100} / {100/1000} == {10/10}
            yield return new TestCaseData(
                new Fraction(10, 100, false),
                new Fraction(100, 1000, false),
                new Fraction(10, 10, false));
            // {10/100} / {1000/10000} == {100/100}
            yield return new TestCaseData(
                new Fraction(10, 100, false),
            ...
            yield return new TestCaseData(
                new Fraction(10, 100, false),
                new Fraction(5, 10, false),
                new Fraction(2, 10, false));
            // {10/100} / {50/100} == {1/5}  
            yield return new TestCaseData(
                new Fraction(10, 100, false),
                new Fraction(50, 100, false),
                new Fraction(1, 5, false));
            // {10/100} / {500/1000} == {10/50}  
            yield return new TestCaseData(
                new Fraction(10, 100, false),
                new Fraction(500, 1000, false),
                new Fraction(10, 50, false));
            // {10/100} / {5000/10000} == {100/500} 
            yield return new TestCaseData(
                new Fraction(10, 100, false),
            ...
            yield return new TestCaseData(
                ...
                new Fraction(100, 10, false),
                new Fraction(1, 100, false));
            // {10/100} / {1000/100} == {1/100}   
            yield return new TestCaseData(
                new Fraction(10, 100, false),
                new Fraction(1000, 100, false),
                new Fraction(1, 100, false));
            // {10/100} / {10000/1000} == {10/1000}
            yield return new TestCaseData(
                new Fraction(10, 100, false),
            ...
            yield return new TestCaseData(
                ...
                new Fraction(500, 10, false),
                new Fraction(1, 500, false));
            // {10/100} / {5000/100} == {1/500}   
            yield return new TestCaseData(
                new Fraction(10, 100, false),
                new Fraction(5000, 100, false),
                new Fraction(1, 500, false));
            // {10/100} / {50000/1000} == {10/5000} 
            yield return new TestCaseData(
                new Fraction(10, 100, false),
    ...
    public void The_terms_expansion_is_constrained(Fraction a, Fraction b, Fraction expectedValue) {
        ...
        Assert.That(a.Reciprocal().Divide(b.Reciprocal()), Is.EqualTo(expectedValue.Reciprocal()).Using(StrictTestComparer.Instance)); // 1/a / 1/b = 1/c
        Assert.That(a.Reciprocal().Negate().Divide(b.Reciprocal().Negate()), Is.EqualTo(expectedValue.Reciprocal()).Using(StrictTestComparer.Instance)); // -1/a / -1/b = 1/c
        Assert.That(a.Reciprocal().Negate().Divide(b.Negate().Reciprocal()), Is.EqualTo(expectedValue.Reciprocal()).Using(StrictTestComparer.Instance)); // -1/a / 1/-b = 1/c
        Assert.That(a.Negate().Reciprocal().Divide(b.Reciprocal().Negate()), Is.EqualTo(expectedValue.Reciprocal()).Using(StrictTestComparer.Instance)); // 1/-a / -1/b = 1/c
        Assert.That(a.Negate().Reciprocal().Divide(b.Negate().Reciprocal()), Is.EqualTo(expectedValue.Reciprocal()).Using(StrictTestComparer.Instance)); // 1/-a / 1/-b = 1/c
        Assert.That(a.Negate().Reciprocal().Negate().Divide(b.Negate().Reciprocal().Negate()), Is.EqualTo(expectedValue.Reciprocal()).Using(StrictTestComparer.Instance)); // -1/-a / -1/-b = 1/c
        ...
        Assert.That(a.Reciprocal().Negate().Divide(b.Reciprocal()), Is.EqualTo(expectedValue.Reciprocal().Negate()).Using(StrictTestComparer.Instance)); // -1/a / 1/b = -1/c
        Assert.That(a.Reciprocal().Divide(b.Reciprocal().Negate()), Is.EqualTo(expectedValue.Reciprocal().Negate()).Using(StrictTestComparer.Instance)); // 1/a / -1/b = -1/c
        Assert.That(a.Reciprocal().Divide(b.Negate().Reciprocal()), Is.EqualTo(expectedValue.Reciprocal().Negate()).Using(StrictTestComparer.Instance)); // 1/a / 1/-b = -1/c
        Assert.That(a.Negate().Reciprocal().Divide(b.Reciprocal()), Is.EqualTo(expectedValue.Reciprocal().Negate()).Using(StrictTestComparer.Instance)); // 1/-a / 1/b = -1/c
        Assert.That(a.Negate().Reciprocal().Negate().Divide(b.Negate().Reciprocal()), Is.EqualTo(expectedValue.Reciprocal().Negate()).Using(StrictTestComparer.Instance)); // -1/-a / 1/-b = -1/c
        Assert.That(a.Negate().Reciprocal().Divide(b.Negate().Reciprocal().Negate()), Is.EqualTo(expectedValue.Reciprocal().Negate()).Using(StrictTestComparer.Instance)); // 1/-a / -1/-b = -1/c
    }
    ...
    public void The_resulting_denominator_is_increased_incrementally_when_dividing_by_integers_large_and_large() {
        // Arrange
        var initialValue = new Fraction(10, 100, false);
        var expectedValue = new Fraction(1, 100_000_000, false);
        // Act
